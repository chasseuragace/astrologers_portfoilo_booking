/// Item row component for Profile list.
...
export function ProfileItemRow({ item, onView, onDelete }: ProfileItemRowProps) {
  return (
    <div className="flex items-center justify-between rounded border p-4 hover:bg-gray-50">
      <div className="flex-1">
        <h3 className="font-semibold">{item.name || 'Unnamed Profile'}</h3>
        {item.description && (
